 ...
 (function(a) {
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseStart: function(e, f, b) {
            ...
            this.originalPageY = e.pageY; (g.cursorAt && this._adjustOffsetFromHelper(g.cursorAt));
            this.domPosition = {
            ...
            if (this.options.values && this.options.values.length) {
                ...
                this.handles.each(function(q, o) {
                    ...
                    if (m.options.range === true) {
                        if (m.orientation == "horizontal") { (q == 0) && m.range.stop(1, 1)[d ? "animate": "css"]({
                                left: p + "%"
                            },
                            e.animate); (q == 1) && m.range[d ? "animate": "css"]({
                        ...
                        } else { (q == 0) && m.range.stop(1, 1)[d ? "animate": "css"]({
                                bottom: (p) + "%"
                            },
                            e.animate); (q == 1) && m.range[d ? "animate": "css"]({
                ...
                this.handle.stop(1, 1)[d ? "animate": "css"](c, e.animate); (g == "min") && (this.orientation == "horizontal") && this.range.stop(1, 1)[d ? "animate": "css"]({
                    width: f + "%"
                },
                e.animate); (g == "max") && (this.orientation == "horizontal") && this.range[d ? "animate": "css"]({
                    width: (100 - f) + "%"
                },
                {
                    queue: false,
                ...
                e.animate); (g == "max") && (this.orientation == "vertical") && this.range[d ? "animate": "css"]({
                    height: (100 - f) + "%"
                },
                {
                    queue: false,
    ...
    c.widget("ui.tabs", {
        ...
        _tabify: function(q) {
            ...
            if (q) {
                ...
                f.disabled = c.unique(f.disabled.concat(c.map(this.lis.filter(".ui-state-disabled"),
                function(s, o) {
            ...
            function(i, o) {
                ...
                o.hide().removeClass("ui-tabs-hide").animate(k, k.duration || "normal",
                function() {
                    g(o, k);
            ...
            this.anchors.bind(f.event + ".tabs",
            function() {
                var o = this,
                u = c(this).closest("li"),
        ...
        remove: function(d) {
            ...
            f.disabled = c.map(c.grep(f.disabled,
            function(j, h) {
                return j != d
            }),
            function(j, h) {
...
jQuery.effects || (function(g) {
    g.effects = {};
    g.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "color", "outlineColor"],
    function(l, k) {
    ...
    a.effects.highlight = function(b) {
        return this.queue(function() {
            ...
            d.show().css({
                ...
                duration: b.duration,
                easing: b.options.easing,
                complete: function() { (f == "hide" && d.hide());
                    a.effects.restore(d, c); (f == "show" && !a.support.opacity && this.style.removeAttribute("filter")); (b.callback && b.callback.apply(this, arguments));
                    d.dequeue()
                }
            })
        })
